...
/**
 * класс вызывается при ошибке, когда введённого значения нет в словаре. В нём можно выбрать опцию добавления нового
 * значения (тогда откроется dict.fxml), либо не добавлять его (тогда окно закроется).
  */
public class confWindowController{
    ...
    public void dictOpen() throws IOException {
        ...
        // передача буквы в поле ввода буквы, которую пользователь будет добавлять
        controller.showLetter(Database.unknownLetter);
